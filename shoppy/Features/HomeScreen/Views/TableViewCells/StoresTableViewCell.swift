...
class StoresTableViewCell: UITableViewCell {
    static let cellIdentifier = "StoresTableViewCell"
    ...
    private lazy var collectionItems: UICollectionView = {
        ...
        collectionItems.register(StoreCollectionViewCell.self, forCellWithReuseIdentifier: StoreCollectionViewCell.cellIdentifier)
...
extension StoresTableViewCell : UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: StoreCollectionViewCell.cellIdentifier, for: indexPath) as! StoreCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        let storeCollectionViewCell = cell as! StoreCollectionViewCell
        
        storeCollectionViewCell.sectionItemDataModel = item
    }
    
}

// MARK:- Layout flow
extension StoresTableViewCell: UICollectionViewDelegateFlowLayout{
